<template>
  <q-page>
                ...
                <q-item>
                  ...
                  <q-item-section side top>
                    <div class="q-gutter-xs">
                      <q-btn dense flat round color="green" icon="add_circle" @click="addNewTrack(tracklist)" />
                      <q-btn dense flat round color="red" icon="delete" @click="removeTracklist(tracklist)" />
                    </div>
                  </q-item-section>
                </q-item>
    ...
    <WildseaTrackEditDialog ref="editTrackDialog" @on-save="onNewTrack" />
  </q-page>
</template>
...
const editTrackDialog: Ref<WildseaTrackEditDialog | null> = ref(null);
...
const currentTrackList: Ref<WildseaTracklist | null> = ref(null);

function addNewTrack (tracklist: WildseaTracklist) {
  editTrackDialog.value.editNew();
  currentTrackList.value = tracklist;
}

function onNewTrack (track: WildseaTrack) {
  if (currentTrackList.value) {
    currentTrackList.value.tracks.push(track);
    tracklistStore.set(currentTrackList.value);
  }
}
</script>
